"""CLI для проверки сохранения контекста между запусками."""
...
def run_dialog(
    ...
    print("Команды: /history — журнал, /dialogs — сменить тему, /exit — выход.\n")
...
def main() -> None:
    ...
    database_path = current_directory / "data" / "bublik-context.db"
    memory = SQLiteContextRepository(database_path)
    client = Groq(api_key=api_key)

    print("🤖 День 7 — Бублик с несколькими контекстами")
