...
from tokens import RequestTokenUsage
...
class ConversationUsage:
    """Накопленная фактическая стоимость диалога."""
...
class SQLiteContextRepository:
    ...
    def get_context_messages(
        ...
        """Загружает всю успешную историю в исходном порядке."""
    ...
    def get_conversation_usage(self, conversation_id: str) -> ConversationUsage:
        """Суммирует фактические API-токены и стоимость всех запросов."""
